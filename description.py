...
def search():
    ...
    backpic = Label(root2, image=pic).place(x=0, y=0)
    ...
    genreLabel = Label(root2, text='Genres', font=('cooper black', 30, 'bold'), bg='#B39266', fg='white')
...
movieLabel = Label(root, text="Movie Name:", font=('algerian', 30, 'bold'), bd=4, bg='#DEDCDD', fg='gray20')
...
moviesearchButton = Button(root, text='SEARCH', font=('FELIX TITLING', 20, 'bold'), bd=5, bg='#D9D7D9', relief=GROOVE,
                           justify=CENTER, command=search)
